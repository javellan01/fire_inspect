	...
	<div class="container-fluid">
		<div class="card">
			...
			<div class="card-body" id="inspEnvioMulti">	  
                <h3 class="text-xl my-2"><i class="nav-icon cui-magnifying-glass"></i> <?php echo $extintor['bool_carreta'].' '.$extintor['tx_tipo'];?></h3>
                ...
                <h4><i class="nav-icon cui-calender"></i> Vencimento: <?php echo $inspecao['dt_inspecao'];?></h4>
                <div class="card">
					<div class="card-header">
                ...
                <tr class="m-2">
                    ...
                    <input type="checkbox" class="btn-check" id="ch1" name="ch1" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch2">Sinal Horizontal</label>    
                    <input type="checkbox" class="btn-check" id="ch2" name="ch2" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch3">Local Adequado</label>    
                    <input type="checkbox" class="btn-check" id="ch3" name="ch3" value="C">
                    </td>
                </tr>
                <tr class="m-2">
                    <td>
                    <label class="btn btn-outline-danger" for="ch4">Acesso Obstruído</label>    
                    <input class="btn-check" type="checkbox" id="ch4" name="ch4" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch5">Agente Ext. Adequado</label>    
                    <input class="btn-check" type="checkbox" id="ch5" name="ch5" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch6">Suporte</label>    
                    <input class="btn-check" type="checkbox" id="ch6" name="ch6" value="C">
                    </td>
                </tr>
                <tr class="m-2">
                    <td>
                    <label class="btn btn-outline-danger" for="ch7">Pressão Nominal</label>    
                    <input class="btn-check" type="checkbox" id="ch7" name="ch7" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch8">Teste Hidrostático</label>    
                    <input class="btn-check" type="checkbox" id="ch8" name="ch8" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch9">Carga / Peso</label>    
                    <input class="btn-check" type="checkbox" id="ch9" name="ch9" value="C">
                    </td>
                </tr>
                <tr class="m-2">
                    <td>
                    <label class="btn btn-outline-danger" for="ch10">Manômetro</label>    
                    <input class="btn-check" type="checkbox" id="ch10" name="ch10" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch11">Cilindro</label>    
                    <input class="btn-check" type="checkbox" id="ch11" name="ch11" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger"  for="ch12">Etiqueta</label>    
                    <input class="btn-check" type="checkbox" id="ch12" name="ch12" value="C">
                    </td>
                </tr>
                <tr class="m-2">
                    <td>
                    <label class="btn btn-outline-danger" for="ch13">Rótulo</label>    
                    <input class="btn-check" type="checkbox" id="ch13" name="ch13" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch14">Alça</label>    
                    <input class="btn-check" type="checkbox" id="ch14" name="ch14" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger"  for="ch15">Gatilho</label>    
                    <input class="btn-check" type="checkbox" id="ch15" name="ch15" value="C">
                    </td>
                </tr>
                <tr class="m-2">
                    <td>
                    <label class="btn btn-outline-danger" for="ch16">Trava</label>    
                    <input class="btn-check" type="checkbox" id="ch16" name="ch16" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch17">Lacre</label>    
                    <input class="btn-check" type="checkbox" id="ch17" name="ch17" value="C">
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch18">Mangueira</label>    
                    <input class="btn-check" type="checkbox" id="ch18" name="ch18" value="C">
                    </td>
                </tr>
                <tr class="m-2">
                    <td>
                    <label class="btn btn-outline-danger" for="ch19">Punho</label>    
                    <input class="btn-check" type="checkbox" id="ch19" name="ch19" value="C" disabled>
                    </td>
                    <td>
                    <label class="btn btn-outline-danger" for="ch20">Difusor</label>    
                    <input class="btn-check" type="checkbox" id="ch20" name="ch20" value="C" disabled>
                    </td>
                </tr>
                </table>
				<div class="input-group">
                    <h5 class="input-group-text">Comentário: ( {{multi.textData.length}} / 256 caracteres)</h5>  
                        <textarea v-model="multi.textData" class="form-control" maxlenght="256" row="3"></textarea>    
				</div>	
                </div>
				<div class="d-grid gap-2 col-8 mx-auto">
					<button 
					@click="multipiece.insertpiece"
					class="btn btn-outline-primary uppercase btn-lg">
					Cadastrar Inspeção
					</button>
				</div>
        ...
        <div class="d-grid gap-2 col-8 mx-auto" v-if="multi.saveSucess">
					<button 
					class="btn btn-success uppercase btn-lg" >
